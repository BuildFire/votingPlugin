...
(function (angular, buildfire, window) {
    angular
        .module('votingPluginContent', ['ngRoute', 'ngAnimate'])
        ...
        .run(['Location', '$location', '$rootScope', 'VoteCache', 'ViewStack', 'Context',
            function (Location, $location, $rootScope, VoteCache, ViewStack, Context) {
