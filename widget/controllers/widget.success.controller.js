...
(function (angular, buildfire) {
  angular
    ...
    .controller('WidgetSuccessCtrl', ['$scope', 'ViewStack', 'VoteCache', '$sce','$rootScope',
      function ($scope, ViewStack, VoteCache, $sce, $rootScope) {

        var WidgetSuccess = this;
        var breadCrumbFlag = true;

        if (VoteCache.getReward()) {
          WidgetSuccess.reward = VoteCache.getReward();
        }
