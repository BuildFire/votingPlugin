...
(function (angular, buildfire) {
  angular
    ...
    .controller('WidgetCodeCtrl', ['$scope', 'ViewStack', 'VotingAPI', 'VoteCache', '$rootScope', 'Buildfire', 'Context',
      function ($scope, ViewStack, VotingAPI, VoteCache, $rootScope, Buildfire, Context) {
        ...
        if (VoteCache.getApplication()) {
          WidgetCode.application = VoteCache.getApplication();
        }
