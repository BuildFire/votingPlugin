...
(function (angular) {
  angular
    ...
    .controller('WidgetAmountCtrl', ['$scope', 'ViewStack', 'VoteCache', 'TAG_NAMES', 'DataStore', '$sce', '$rootScope',
      function ($scope, ViewStack, VoteCache, TAG_NAMES, DataStore, $sce, $rootScope) {
        ...
        if (VoteCache.getApplication()) {
          WidgetAmount.application = VoteCache.getApplication();
        }
